      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          <Card className="card-elegant max-w-4xl mx-auto animate-slide-up">
            <CardHeader className="text-center">
              <div className="w-24 h-24 bg-gradient-primary rounded-full flex items-center justify-center text-primary-foreground text-3xl font-bold mx-auto mb-4">
                {panchayat.sarpanch.name.split(' ').map(n => n[0]).join('')}
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {panchayat.members.map((member, index) => (
              <Card 
                key={member.name} 
              ...
              >
                <CardHeader className="text-center">
                  <div className="w-16 h-16 bg-accent text-accent-foreground rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-3">
        ...
        <Card className="card-elegant max-w-2xl mx-auto animate-slide-up">
          <CardHeader className="text-center">
            <div className="w-20 h-20 bg-secondary text-secondary-foreground rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              {panchayat.secretary.name.split(' ').map(n => n[0]).join('')}
            </div>
